	...
	if (map.is_open())
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			case 2:
				...
				break;
			case 3:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground3_ID));
				break;
			case 7:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground4_ID));
				break;
			case 8:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground5_ID));
				break;
			case 10:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground6_ID));
				break;
			case 11:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground7_ID));
				break;
			case 14:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground8_ID));
				break;
			case 16:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground9_ID));
				break;
			case 18:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground10_ID));
				break;
			case 21:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground11_ID));
				break;
			case 35:
				_staticObject->push_back(new Ground(posX, posY, width, height, EnumID::Ground12_ID));
				break;
			/*case 13:
