...
{
	D3DXMATRIX matrix;
	D3DXMatrixIdentity(&matrix);   //Làm sạch ma trận, đưa về ma trận mặc định
	//Tạo ma trận 4 (trong slide Transform)
	matrix._22 = -1;				
	...
	D3DXVec3Transform(&MatrixResult, &pos3, &matrix); //Nhân ma trận
	//Kết thúc transform
